"""V164 Runner Script"""
import argparse
from src.alpha_research_v164 import V164Runner

def main():
    parser = argparse.ArgumentParser(description='Run V164 Audit')
    parser.add_argument('--year', type=int, default=2024, help='Year to audit')
    args = parser.parse_args()
    
    runner = V164Runner(output_dir='reports')
    result = runner.run_audit(args.year)
    
    print("\n" + "=" * 70)
    print(f"V164 Audit Summary - Year {args.year}")
    print("=" * 70)
