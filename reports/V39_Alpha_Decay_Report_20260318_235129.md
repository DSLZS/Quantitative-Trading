...
|------|----------|----------|----------|------|
| A (0.1% 滑点) | 98 | 97 | 195 | ⚠️ |
| B (0.3% 滑点) | 97 | 96 | 193 | ⚠️ |
...
║  Final NAV             :  101358.93 元                             ║
║  Total Return (固定)    :      1.36%                              ║
╠══════════════════════════════════════════════════════════════╣
║  【性能指标】                                               ║
║  年化收益率            :      1.18%                              ║
║  夏普比率              :      0.164                              ║
...
║  【固定基准审计】                                           ║
║  Fixed Initial Capital :  100000.00 元 (锁定分母)          ║
║  Final NAV             :   95340.02 元                             ║
║  Total Return (固定)    :     -4.66%                              ║
╠══════════════════════════════════════════════════════════════╣
║  【性能指标】                                               ║
║  年化收益率            :     -4.06%                              ║
║  夏普比率              :     -0.068                              ║
...
**场景 A (0.1% 滑点) 总收益**: 1.36%
**场景 B (0.3% 滑点) 总收益**: -4.66%

**滑点影响**: 0.3% 滑点导致收益减少 6.02%
