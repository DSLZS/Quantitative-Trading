...
|------|----------|----------|----------|------|
| A (0.1% 滑点) | 167 | 161 | 328 | ⚠️ |
| B (0.3% 滑点) | 165 | 162 | 327 | ⚠️ |
...
║  Final NAV             :   90521.19 元                             ║
║  Total Return (固定)    :     -9.48%                              ║
╠══════════════════════════════════════════════════════════════╣
║  【性能指标】                                               ║
║  年化收益率            :     -8.29%                              ║
║  夏普比率              :     -0.190                              ║
...
║  【固定基准审计】                                           ║
║  Fixed Initial Capital :  100000.00 元 (锁定分母)          ║
║  Final NAV             :   76023.92 元                             ║
║  Total Return (固定)    :    -23.98%                              ║
╠══════════════════════════════════════════════════════════════╣
║  【性能指标】                                               ║
║  年化收益率            :    -21.20%                              ║
║  夏普比率              :     -0.752                              ║
...
**场景 A (0.1% 滑点) 总收益**: -9.48%
**场景 B (0.3% 滑点) 总收益**: -23.98%
