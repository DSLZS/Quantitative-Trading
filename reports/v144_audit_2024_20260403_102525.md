...
|--------|-------|-----------|--------|
| T+1 Rank IC | 0.0617 | > 0.055 | ✓ PASSED |
| IC IR | 0.34 | > 0.70 | ✗ FAILED |
| IC Std | 0.1807 | < 0.04 | ✗ |
...
|--------|------|------|-------------|
| T+1 IC | 0.0598 | 0.0617 | +0.0019 |
| IC IR | 0.60 | 0.34 | -0.26 |
| IC Std | N/A | 0.1807 | - |
...
|---------|-----|---------|
| T+1 | 0.0617 | Baseline |
| T+3 | 0.0505 | ✓ Monotonic |
| T+5 | 0.0497 | ✓ Monotonic |

**Decay Pattern**: T+1(0.0617) -> T+3(0.0505) -> T+5(0.0497)
...
|--------|--------|--------|--------|
| T+1 Rank IC | > 0.055 | 0.0617 | ✓ |
| IC IR | > 0.70 | 0.34 | ✗ |
| IC Std | < 0.04 | 0.1807 | ✗ |
| IC Decay | Monotonic | T+1(0.0617) -> T+3(0.0505) -> T+5(0.0497) | ✓ |
