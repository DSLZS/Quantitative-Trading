...
|--------|-------|-----------|--------|
| T+1 Rank IC | 0.0275 | > 0.055 | ✗ FAILED |
| IC IR | 0.19 | > 0.70 | ✗ FAILED |
| IC Std | 0.1470 | < 0.04 | ✗ |
...
|--------|---------|--------|--------------|
| liquidity_alpha_sci_volume_rank | IC_mean=0.0304 | lambda=0.50 | weight=0.0060 |
| momentum_20_sci_reversion_5 | IC_mean=-0.0165 | lambda=0.50 | weight=0.0038 |
| momentum_20_sci_momentum_5 | IC_mean=-0.0165 | lambda=0.50 | weight=0.0038 |
| volatility_10_sci_reversion_5 | IC_mean=0.0057 | lambda=0.50 | weight=0.0036 |
| volatility_10_sci_momentum_5 | IC_mean=0.0057 | lambda=0.50 | weight=0.0036 |
...
|--------|------|------|-------------|
| T+1 IC | 0.0598 | 0.0275 | -0.0323 |
| IC IR | 0.60 | 0.19 | -0.41 |
| IC Std | N/A | 0.1470 | - |
...
|---------|-----|---------|
| T+1 | 0.0275 | Baseline |
| T+3 | 0.0234 | ✓ Monotonic |
| T+5 | 0.0263 | ✗ Non-monotonic |

**Decay Pattern**: T+1(0.0275) -> T+3(0.0234) -> T+5(0.0263)
...
|--------|--------|--------|--------|
| T+1 Rank IC | > 0.055 | 0.0275 | ✗ |
| IC IR | > 0.70 | 0.19 | ✗ |
| IC Std | < 0.04 | 0.1470 | ✗ |
| IC Decay | Monotonic | T+1(0.0275) -> T+3(0.0234) -> T+5(0.0263) | ✗ |
