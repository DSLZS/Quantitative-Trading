...
| 2024 | 0.0108 | 0.16 | -51.13% | -0.76 | -62.76% | ✗ |
...
| Metric | Value | Target | Status |
|--------|-------|--------|--------|
| T+1 Rank IC | 0.0108 | 0.05 | ✗ |
| IC IR | 0.16 | >0.60 | ✗ |
| Annual Return | -51.13% | - | - |
| Sharpe Ratio | -0.76 | >1.0 | ✗ |
| Max Drawdown | -62.76% | 0.25 | ✗ |
