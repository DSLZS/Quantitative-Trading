...
|--------|-------|-----------|--------|
| T+1 Rank IC | 0.0196 | > 0.055 | ✗ FAILED |
| IC IR | 0.15 | > 0.70 | ✗ FAILED |
| IC Std | 0.1283 | < 0.04 | ✗ |
...
|--------|---------|--------|--------------|
| volatility_10_sci_reversion_5 | IC_mean=0.0057 | lambda=2.00 | weight=0.0007 |
| volatility_10_sci_momentum_5 | IC_mean=0.0057 | lambda=2.00 | weight=0.0007 |
| liquidity_alpha_sci_volume_rank | IC_mean=0.0304 | lambda=1.39 | weight=0.0014 |
...
|--------|------|------|-------------|
| T+1 IC | 0.0598 | 0.0196 | -0.0402 |
| IC IR | 0.60 | 0.15 | -0.45 |
| IC Std | N/A | 0.1283 | - |
...
|---------|-----|---------|
| T+1 | 0.0196 | Baseline |
| T+3 | 0.0147 | ✓ Monotonic |
| T+5 | 0.0207 | ✗ Non-monotonic |

**Decay Pattern**: T+1(0.0196) -> T+3(0.0147) -> T+5(0.0207)
...
|--------|--------|--------|--------|
| T+1 Rank IC | > 0.055 | 0.0196 | ✗ |
| IC IR | > 0.70 | 0.15 | ✗ |
| IC Std | < 0.04 | 0.1283 | ✗ |
| IC Decay | Monotonic | T+1(0.0196) -> T+3(0.0147) -> T+5(0.0207) | ✗ |
