...
|------|----------|----------|----------|------|
| A (0.1% 滑点) | 81 | 70 | 151 | ⚠️ |
| B (0.3% 滑点) | 81 | 71 | 152 | ⚠️ |
...
║  Final NAV             :  105326.64 元                             ║
║  Total Return (固定)    :      5.33%                              ║
╠══════════════════════════════════════════════════════════════╣
║  【性能指标】                                               ║
║  年化收益率            :      4.61%                              ║
║  夏普比率              :      0.330                              ║
...
║  【固定基准审计】                                           ║
║  Fixed Initial Capital :  100000.00 元 (锁定分母)          ║
║  Final NAV             :   98235.64 元                             ║
║  Total Return (固定)    :     -1.76%                              ║
╠══════════════════════════════════════════════════════════════╣
║  【性能指标】                                               ║
║  年化收益率            :     -1.53%                              ║
║  夏普比率              :      0.018                              ║
...
1. **逻辑一致性修复**: 
   - ✅ 成功修复 V38 的 Avg Holding Days: 0.0 错误
...
**场景 A (0.1% 滑点) 总收益**: 5.33%
**场景 B (0.3% 滑点) 总收益**: -1.76%

**滑点影响**: 0.3% 滑点导致收益减少 7.09%
