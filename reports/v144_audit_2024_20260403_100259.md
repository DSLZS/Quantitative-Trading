...
|--------|-------|-----------|--------|
| T+1 Rank IC | 0.0195 | > 0.055 | ✗ FAILED |
| IC IR | 0.14 | > 0.70 | ✗ FAILED |
| IC Std | 0.1358 | < 0.04 | ✗ |
...
|--------|------|------|-------------|
| T+1 IC | 0.0598 | 0.0195 | -0.0403 |
| IC IR | 0.60 | 0.14 | -0.46 |
| IC Std | N/A | 0.1358 | - |
...
| T+5 | 0.0215 | ✗ Non-monotonic |

**Decay Pattern**: T+1(0.0195) -> T+3(0.0147) -> T+5(0.0215)
...
|--------|--------|--------|--------|
| T+1 Rank IC | > 0.055 | 0.0195 | ✗ |
| IC IR | > 0.70 | 0.14 | ✗ |
| IC Std | < 0.04 | 0.1358 | ✗ |
| IC Decay | Monotonic | T+1(0.0195) -> T+3(0.0147) -> T+5(0.0215) | ✗ |
