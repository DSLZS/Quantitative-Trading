...
| 2024 | 0.0086 | 0.12 | 51.30% | 0.84 | -58.19% | ✗ |
...
| Metric | Value | Target | Status |
|--------|-------|--------|--------|
| T+1 Rank IC | 0.0086 | 0.05 | ✗ |
| IC IR | 0.12 | >0.60 | ✗ |
| Annual Return | 51.30% | - | - |
| Sharpe Ratio | 0.84 | >1.0 | ✗ |
| Max Drawdown | -58.19% | 0.25 | ✗ |
