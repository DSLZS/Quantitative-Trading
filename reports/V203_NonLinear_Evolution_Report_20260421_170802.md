...
|--------|-------|--------|--------|
| T+1 Rank IC | 0.0094 | 0.05 | ✗ |
| IC IR | 0.08 | >0.60 | ✗ |
| Annual Return | -27.36% | - | - |
| Sharpe Ratio | -1.23 | >1.0 | ✗ |
| Max Drawdown | -26.77% | 0.3 | ✓ |

### 2022 (Volatile Rotation Year)

| Metric | Value | Target | Status |
|--------|-------|--------|--------|
| T+1 Rank IC | 0.0312 | 0.05 | ✗ |
| IC IR | 0.25 | >0.60 | ✗ |
| Annual Return | -29.92% | - | - |
| Sharpe Ratio | -1.25 | >1.0 | ✗ |
| Max Drawdown | -36.19% | 0.3 | ✗ |

### 2024 (Challenge Year)

| Metric | Value | Target | Status |
|--------|-------|--------|--------|
| T+1 Rank IC | -0.0019 | 0.1 | ✗ |
| IC IR | -0.01 | >0.60 | ✗ |
| Annual Return | -26.58% | - | - |
| Sharpe Ratio | -0.77 | >1.0 | ✗ |
| Max Drawdown | -34.59% | 0.25 | ✗ |
...
|-----------|-------|--------|--------|
| Sharpe Mean | -1.084 | >0.8 | ✗ |
| Sharpe Std | 0.224 | <0.5 | ✓ |
| Sharpe CV | inf | <0.6 | ✗ |
| IC Mean | 0.0129 | >0.05 | ✗ |
| IC Std | 0.0137 | <0.10 | ✓ |
...
|--------|------|------|-------|
| IC Mean (Cross-Year) | - | 0.0129 | - |
| Sharpe Std (Stability) | - | 0.224 | - |
...
2. **Performance**
   - Cross-year Sharpe Mean: -1.084
   - Cross-year Sharpe Std: 0.224
