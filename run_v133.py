"""V133 回测运行脚本 - ICIR 加权增强版"""
import json
from src.alpha_research_v133 import run_v133_backtest
from loguru import logger

if __name__ == "__main__":
    logger.info("=" * 80)
    logger.info("V133 Backtest - Starting (ICIR Weighted)")
    logger.info("=" * 80)
