"""V168 Runner Script - Lower Lead-Lag Threshold"""
import argparse
from src.alpha_research_v168 import V168Runner

def main():
    parser = argparse.ArgumentParser(description='Run V168 Audit')
    parser.add_argument('--year', type=int, default=2024, help='Year to audit')
    args = parser.parse_args()
    
    runner = V168Runner(output_dir='reports')
    result = runner.run_audit(args.year)
    
    print("\n" + "=" * 70)
    print(f"V168 Audit Summary - Year {args.year}")
    print("=" * 70)
