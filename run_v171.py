"""V171 Runner Script - Elite 5 Factors"""
import argparse
from src.alpha_research_v171 import V171Runner

def main():
    parser = argparse.ArgumentParser(description='Run V171 Audit')
    parser.add_argument('--year', type=int, default=2024, help='Year to audit')
    args = parser.parse_args()
    
    runner = V171Runner(output_dir='reports')
    result = runner.run_audit(args.year)
    
    print("\n" + "=" * 70)
    print(f"V171 Audit Summary - Year {args.year}")
    print("=" * 70)
