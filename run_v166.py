"""V166 Runner Script - Complete Clone of V155"""
import argparse
from src.alpha_research_v166 import V166Runner

def main():
    parser = argparse.ArgumentParser(description='Run V166 Audit')
    parser.add_argument('--year', type=int, default=2024, help='Year to audit')
    args = parser.parse_args()
    
    runner = V166Runner(output_dir='reports')
    result = runner.run_audit(args.year)
    
    print("\n" + "=" * 70)
    print(f"V166 Audit Summary - Year {args.year}")
    print("=" * 70)
