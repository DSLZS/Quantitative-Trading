"""V128 回测运行脚本 - ICIR 加权组合"""
import json
from src.alpha_research_v128 import run_v128_backtest
from loguru import logger

if __name__ == "__main__":
    logger.info("=" * 80)
    logger.info("V128 Backtest - Starting (ICIR Weighted Portfolio)")
    logger.info("=" * 80)
