"""V163 Runner Script"""
import argparse
from src.alpha_research_v163 import V163Runner

def main():
    parser = argparse.ArgumentParser(description='Run V163 Audit')
    parser.add_argument('--year', type=int, default=2024, help='Year to audit')
    args = parser.parse_args()
    
    runner = V163Runner(output_dir='reports')
    result = runner.run_audit(args.year)
    
    print("\n" + "=" * 70)
    print(f"V163 Audit Summary - Year {args.year}")
    print("=" * 70)
