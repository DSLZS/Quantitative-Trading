"""V170 Runner Script - Equal Weight"""
import argparse
from src.alpha_research_v170 import V170Runner

def main():
    parser = argparse.ArgumentParser(description='Run V170 Audit')
    parser.add_argument('--year', type=int, default=2024, help='Year to audit')
    args = parser.parse_args()
    
    runner = V170Runner(output_dir='reports')
    result = runner.run_audit(args.year)
    
    print("\n" + "=" * 70)
    print(f"V170 Audit Summary - Year {args.year}")
    print("=" * 70)
